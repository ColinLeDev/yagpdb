...
var Command = &commands.YAGCommand{
	...
	RunFunc: func(data *dcmd.Data) (interface{}, error) {
		info := fmt.Sprintf(`**YagBC - Yagpdb By Colin**
...
The bot is **NOT** run by Botlabs but is open source (<https://github.com/botlabs-gg/yagpdb>), so if you know Go and want to make some contributions, feel free to make a PR.
